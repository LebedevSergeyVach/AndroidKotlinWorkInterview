...
6. [**Gradle и build.gradle.kts**](Gradle/README.md)
7. [**Архитектура MVVM (Model-View-ViewModel)**](MVVM/README.md)
8. [**RecyclerView - ViewGroup**](RecyclerView/README.md)
9. [**Activity и ViewBinding**](Activity/README.md)
